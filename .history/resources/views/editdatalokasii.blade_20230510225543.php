              ...
              <form method="POST" action="{{ url('/lokasii/update/'.$lokasii->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="lokasialternatif" placeholder="lokasialternatif" value="{{ $lokasialternatif->lokasialternatif}}">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="bobot" placeholder="bobot" value="{{ $bobot->bobot}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="jenis" class="col-sm-2 col-form-label">Jenis</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="jenis" placeholder="jenis" value="{{ $jenis->jenis}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
