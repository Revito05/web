              ...
              <form method="POST" action="{{ url('/kriteria/update/'.$kriteria->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="geografis" class="col-sm-2 col-form-label">kriteria</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama_kriteria" placeholder="kriteria" value="{{ $kriteria->nama_kriteria}}">
                    </div>
                  </div>
                  <div class="form-group row">
