              ...
              <form method="POST" action="{{ url('/kriteria/update/'.$kriteria->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                    <label for="sarana_dan_prasarana" class="col-sm-2 col-form-label">Sarana</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="sarana_dan_prasarana" placeholder="jenis" value="{{ $kriteria->sarana_dan_prasarana}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
