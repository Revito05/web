          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form method="POST" action="{{ url('/kriteria/store')}}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="k.penumpang" class="col-sm-2 col-form-label">Kapasitas Penumpang</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="k.penumpang" placeholder="Kapasitas Penumpang">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="k.tangki" class="col-sm-2 col-form-label">Kapasitas Tangki</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="k.tangki" placeholder="kapasitas Tangki">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="silinder" class="col-sm-2 col-form-label">Silinder</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="silinder" placeholder="Silinder">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="k.mesin" class="col-sm-2 col-form-label">Kapasitas Mesin</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="k.mesin" placeholder="k.mesin">
                    </div>
                  </div>
                  <!-- <div class="form-group row">
                    <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
