              ...
              <div class="card-body">
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>{{$C4min['alternatif'] / $alternatif->kriteria_4}}</td>
                        <td>{{$C5min['alternatif'] / $alternatif->kriteria_5}}</td>
                      </tr>
                @endforeach
                </tbody>
                </table>
                ...
                @foreach ($data as $alternatif)
                    <tr>
                        ...
                        <td>
                            ...
                            (($C4min['alternatif'] / $alternatif->kriteria_4)*$widget4['kriteria'])+
                            (($C5min['alternatif'] / $alternatif->kriteria_5)*$widget5['kriteria'])}}
                        </td>
                    </tr>
                @endforeach
                </tbody>
