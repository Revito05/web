...
<head>
  ...
  {{-- <title>Web Admin_Mobil | {{ $title }}</title> --}}
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><br>Mohamad Revito  Al Fajrii</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Welcome Is Back</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    ...
    <a href="https://wa.me/+6281990686605">Admin</a>
