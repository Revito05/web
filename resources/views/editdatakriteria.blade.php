          ...
          <div class="col-md-12">
            ...
            <div class="card card-info">
              ...
              <form method="POST" action="{{ url('/kriteria/update/'.$kriteria->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="k_penumpang" class="col-sm-2 col-form-label">Kapasitas Penumpang</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="k_penumpang" placeholder="Kapasitas penumpang" value="{{ $kriteria->k_penumpang}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="k_tangki" class="col-sm-2 col-form-label">Kapasitas Tangki</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="k_tangki" placeholder="Kapasitas Tangki" value="{{ $kriteria->k_tangki}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="silinder" class="col-sm-2 col-form-label">Silinder</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="silinder" placeholder="silinder" value="{{ $kriteria->silinder}}">
                    </div>
                    </div>
                    <div class="form-group row">
