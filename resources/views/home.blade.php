...
<head>
	...
	<!-- CSS here -->
	<link rel="stylesheet" href="/fastes-master/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="/fastes-masterassets/css/owl.carousel.min.css">
	<link rel="stylesheet" href="assets/css/slicknav.css">
    <link rel="stylesheet" href="/fastes-master/assets/css/flaticon.css">
    <link rel="stylesheet" href="/fastes-master/assets/css/progressbar_barfiller.css">
    <link rel="stylesheet" href="/fastes-master/assets/css/gijgo.css">
    <link rel="stylesheet" href="/fastes-master/assets/css/animate.min.css">
    <link rel="stylesheet" href="/fastes-master/assets/css/animated-headline.css">
	<link rel="stylesheet" href="/fastes-master/assets/css/magnific-popup.css">
	<link rel="stylesheet" href="/fastes-master/assets/css/fontawesome-all.min.css">
	<link rel="stylesheet" href="/fastes-master/assets/css/themify-icons.css">
	<link rel="stylesheet" href="/fastes-master/assets/css/slick.css">
	<link rel="stylesheet" href="/fastes-master/assets/css/nice-select.css">
    <link rel="stylesheet" href="/fastes-master/assets/css/style.css">
...
<body>
                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="services.html">Harga Services</a></li>
                                    <li><a href="help.html">Kapasitas Help</a></li>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="./fastes-master//assets/js/vendor/modernizr-3.5.0.min.js"></script>
    <!-- Jquery, Popper, Bootstrap -->
    <script src="./fastes-master//assets/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="./fastes-master//assets/js/popper.min.js"></script>
    <script src="./fastes-master//assets/js/bootstrap.min.js"></script>
    <!-- Jquery Mobile Menu -->
    <script src="./fastes-master//assets/js/jquery.slicknav.min.js"></script>

    <!-- Jquery Slick , Owl-Carousel Plugins -->
    <script src="./fastes-master//assets/js/owl.carousel.min.js"></script>
    <script src="./fastes-master//assets/js/slick.min.js"></script>
    <!-- One Page, Animated-HeadLin -->
    <script src="./fastes-master//assets/js/wow.min.js"></script>
    <script src="./fastes-master//assets/js/animated.headline.js"></script>
    <script src="./fastes-master//assets/js/jquery.magnific-popup.js"></script>

    <!-- Date Picker -->
    <script src="./fastes-master//assets/js/gijgo.min.js"></script>
    <!-- Nice-select, sticky -->
    <script src="./fastes-master//assets/js/jquery.nice-select.min.js"></script>
    <script src="./fastes-master//assets/js/jquery.sticky.js"></script>
    <!-- Progress -->
    <script src="./fastes-master//assets/js/jquery.barfiller.js"></script>
    
    <!-- counter , waypoint,Hover Direction -->
    <script src="./fastes-master//assets/js/jquery.counterup.min.js"></script>
    <script src="./fastes-master//assets/js/waypoints.min.js"></script>
    <script src="./fastes-master//assets/js/jquery.countdown.min.js"></script>
    <script src="./fastes-master//assets/js/hover-direction-snake.min.js"></script>

    <!-- contact js -->
    <script src="./fastes-master//assets/js/contact.js"></script>
    <script src="./fastes-master//assets/js/jquery.form.js"></script>
    <script src="./fastes-master//assets/js/jquery.validate.min.js"></script>
    <script src="./fastes-master//assets/js/mail-script.js"></script>
    <script src="./fastes-master//assets/js/jquery.ajaxchimp.min.js"></script>
    
    <!-- Jquery Plugins, main Jquery -->	
    <script src="./fastes-master//assets/js/plugins.js"></script>
    <script src="./fastes-master//assets/js/main.js"></script>
